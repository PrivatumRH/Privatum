...
import { ArrowUpRight, Shield, ShieldAlert, Link2, Lock, Unlock, ArrowRight } from "lucide-react";
  ...
  if (intent.type === "create_paylink") {
    return (
      <div className="mt-3 rounded-xl border border-white/10 bg-white/[0.04] p-3.5 text-xs">
        <div className="flex items-center gap-1.5 font-medium text-white mb-2 pb-2 border-b border-white/5">
  ...
  if (intent.type === "panic_freeze") {
    return (
      <div className="mt-3 rounded-xl border border-[#f54842]/40 bg-[#f54842]/10 p-3.5 text-xs">
        <div className="flex items-center gap-1.5 font-medium text-[#f54842] mb-2 pb-2 border-b border-[#f54842]/20">
    ...
    return (
      <div className="mt-3 rounded-xl border border-white/10 bg-white/[0.04] p-3.5 text-xs">
        ...
        <button
          type="button"
          onClick={() => onApplyIntent(intent)}
          className="w-full flex items-center justify-center gap-1.5 py-2 px-3 rounded-lg font-medium text-black bg-white hover:bg-white/90 transition-colors"
        >
